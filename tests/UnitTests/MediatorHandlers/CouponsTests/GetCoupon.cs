...
//    public GetCoupon()
//    {
//        var coupon = new List<Coupon> { new Coupon { Id = 1,Name = "test1",PercentageDiscount = 20,StartDate = DateTime.Now,EndDate = DateTime.Now.Date.AddDays((2)) },  new Coupon { 2,"test2",21,DateTime.Now,DateTime.Now.Date.AddDays((3)) }};
